<template>
  <div class="nav-container fixed top-0 left-0 right-0 z-50 bg-transparent">
    <div class="relative pl-10 pr-10">
      <div class="is-nav flex items-center justify-between w-full max-w-80 ml-auto mr-auto">
        <div class="logo">
          <!-- <svg
            width="176"
            height="50"
          ...
          >
            <path
              d="M25.7404 34.1778C31.8195 44.7072 17.0319 49.8513 12.9198 51.3577C19.7254 51.5103 36.7281 43.3325 32.107 33.6585C25.5419 19.9148 27.9826 16.6843 30.7836 15.3565C26.5696 17.243 19.6613 23.6485 25.7404 34.1778Z"
              fill="url(#paint0_linear_244_2258)"
            />
            <path
              d="M14.8777 30.983C21.7536 44.7555 15.2528 49.9482 10.2712 52.1094C18.4145 52.0517 30.5119 43.6738 25.349 30.983C18.0144 12.9537 21.3915 5.66915 24.7963 3.7956C19.6781 6.46641 8.00183 17.2106 14.8777 30.983Z"
              fill="url(#paint1_linear_244_2258)"
            />
            <path
              d="M7.40803 37.6717C13.4871 48.201 14.6046 50.3214 10.4925 51.8277C17.298 51.9804 18.5487 43.0384 13.9275 33.3643C7.36245 19.6207 14.2623 16.5965 16.5226 14.6281C12.3086 16.5146 1.32892 27.1423 7.40803 37.6717Z"
              fill="url(#paint2_linear_244_2258)"
            />
            <g filter="url(#filter0_f_244_2258)">
              <path
                d="M18.2448 16.9773C17.4878 19.379 18.2029 25.0242 21.0642 31.7005C22.7088 35.538 22.761 40.9939 21.0642 41.8815"
                stroke="white"
                stroke-width="1.12381"
                stroke-linecap="round"
              />
            </g>
            <g filter="url(#filter1_f_244_2258)">
              <path
                d="M26.2333 23.5557C25.7159 25.2021 27.3319 30.5695 29.2876 35.1463C30.4118 37.777 28.8812 43.1525 27.7214 43.7609"
                stroke="white"
                stroke-width="0.936508"
                stroke-linecap="round"
              />
            </g>
            <g filter="url(#filter2_f_244_2258)">
              <path
                d="M8.24018 25.6704C7.72272 27.3168 9.33871 32.6842 11.2945 37.261C12.4186 39.8917 14.8628 44.2491 13.7029 44.8576"
                stroke="white"
                stroke-width="1.12381"
                stroke-linecap="round"
              />
          ...
          <h1 class="font font-semibold text-3xl text-white">Portfolio</h1>
        </div>
        <nav class="text-white flex justify-between items-center pt-4 pb-4">
          <ul class="flex gap-6">
            <li class="ml-1 mr-1 p-3">Courses</li>
            <li class="ml-1 mr-1 p-3">Resources</li>
          </ul>
        </nav>
      </div>
    </div>
...
.is-nav {
  ...
  border-image: linear-gradient(to right, #1a1a1a, #a3a3a3, #1a1a1a) 1;
}
</style>
